...
<body>
    ...
    <div class="d-flex text-center justify-content-center align-items-center vh-100 bg-light">
        <div class="container ">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="success-content">
                        ...
                        <p>Iremos analisar o seu e-mail e entraremos em contato o mais brevemente possível.</p>
                        <div class="button">
